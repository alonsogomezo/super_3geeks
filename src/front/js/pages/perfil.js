  ...
  return (
    <div className="container mt-3 mb-3 d-flex justify-content-center">
      <div className="row col-6 border border-danger rounded bg-secondary  ">
        <div className="card text-secondary bg-dark mb-3 mt-3 text-center">
          ...
          <div className="card-body">
            ...
            <p>
              <i className="bx bx-mail-send"></i>Email: {store.user?.email}
            </p>
            <p>Direccion: {store.user?.direccion}</p>
            <p>
          ...
          <div className="social-list justify-content-between d-flex rounded">
