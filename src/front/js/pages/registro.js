      ...
      <form className="mb-5" onSubmit={onSubmit}>
        ...
        <div className="form-group row p-3 justify-content-center mb-5">
          <div className="col-10 col-sm-5 text-center">
            <button type="submit" className="btn btn-outline-danger mb-5 shadow p-1 border-white mb-2">
              Crear Perfil
            </button>
          ...
          <h2 className="text-center bg-dark mt-3 border border-dark text-white rounded">
            {" "}
            <img src={Logo} width={40} />
          </h2>
